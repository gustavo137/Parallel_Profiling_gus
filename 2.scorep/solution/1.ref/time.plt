...
set xtics  norangelimit 0.001
set ytics border in scale 1,0.5 nomirror norotate  autojustify
set ytics  norangelimit 0.25
...
I = {0.0, 1.0}
VoxelDistance = 0.0
## Last datafile plotted: "time.out"
plot 'time.out' u 1:2 w lp pt 7 lw 2 title 'time', 'time.out' u 1:(0.7838/$2) w lp pt 5 lw 2 title 'speedup' axis x1y2
#    EOF
