...
int main(int argc, char** argv) {
 ...
 {  CParallel_Timer t("Ring sendrecv TIMING"); 

    // Eliminar el archivo al inicio si es el proceso 0
    if (world_rank == 0) {
        std::remove("ringsr.txg");
    }
    ...
    std::ofstream file("ringsr.txg", std::ios::app);
